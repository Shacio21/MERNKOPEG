...
interface Props {
  data: PembelianItem;
  onClose: () => void;
  onSubmit: (updatedData: PembelianItem) => void;
}

const UpdatePembelian: React.FC<Props> = ({ data, onClose, onSubmit }) => {
  const [formData, setFormData] = useState<PembelianItem>({ ...data });
